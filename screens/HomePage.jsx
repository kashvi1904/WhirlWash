    ...
    <SafeAreaView style={{backgroundColor:'white', width:'100%', height:'100%'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', padding:20}}>
            ...
            <View style={{flexDirection:'row', gap:10}}>
                <TouchableOpacity 
                style={{backgroundColor:'#E2E5F4', width:40, height:40, borderRadius:10, justifyContent:'center', alignItems:'center'}}>
                    <Icon name="bell" size={24} color="#c"/>
                </TouchableOpacity>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 20}}>
            <Image source={require('../assets/LNMIIT.png')}
                   style ={{width:'85%',marginTop: 20, marginLeft:30, height:200, borderRadius:10}}
            />

            <View style={{backgroundColor:'#F5F5F5', minHeight:'20%', width:'85%', borderRadius:5, marginTop:30, marginLeft:30, padding:10}}>
                <Text style={{fontSize:30, fontWeight:400, color:"#3D4EB0"}}>Welcome to WhirlWash!</Text>
                <Text style={{fontSize:16, lineHeight:22, marginTop:5}}>"Laundry made simple. Book machines instantly, verify with OTP, and track your wash cycle—all from your phone. No waiting, no paperwork, just clean clothes effortlessly. Our app eliminates queues, sends timely notifications, and ensures fair machine allocation. Manage your laundry schedule efficiently around your busy day with our user-friendly interface."</Text>
            </View>

            <TouchableOpacity style={{backgroundColor:'#F5F5F5',height:60, width:'85%', marginTop:20, borderRadius:10, marginLeft:30, borderWidth:2, borderColor:'black', justifyContent:'center', alignItems:'center', flexDirection:'row', gap:10}}
                onPress={() => navigation.navigate('Machines')}>
                <Image source = {require('../assets/image.png')}
                 style = {{width:30, height:30}} />
                <Text style={{color:'grey', fontSize:20, fontWeight:'semibold', fontWeight:600}}>Book Machine</Text>
